...
const hero = () => `
  <section class="hero" id="hero" data-chapter>
    <div class="hero__crest" data-hero-crest>
      <img src="${asset('/images/coat-of-arms.png')}" alt="Coat of arms of the Federal Republic of Nigeria" width="46" height="40" />
  ...
  <section class="chapter" id="origins" data-chapter>
    ...
    <div class="two-col">
      ...
      <div class="origins__map">
        ...
        <img class="origins__seal" src="${asset('/images/ondo-seal.png')}" alt="Seal of Ondo State" width="92" height="92" loading="lazy" />
      </div>
    </div>
  </section>`;
