...
export const quotes: Quote[] = [
  ...
  { text: 'Don’t judge us by what you hear. Judge us by what you see.', context: 'Pull-quote on the official site, paired with the passport backlog', source: 'https://bto.ng/', sourceLabel: 'bto.ng — Home' },
  { text: 'Our creed will always remain Nigeria first, Nigeria second, and Nigeria always.', context: 'On receiving Vanguard’s Personality of the Year award, 2024', source: 'https://bto.ng/2024/06/25/2023-personality-of-the-year/', sourceLabel: 'bto.ng, 25 Jun 2024' },
